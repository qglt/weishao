...
namespace gloox
{
                            ...
                            public IqHandler, private MessageHandler, private DiscoNodeHandler
  {
    public:
	  ...
	  /**
       * Quanli 2012 11 30
       * @return The bare xxxx@temp.ruijie.com.cn
       */
	  const std::string mid() const { return m_nick.bare(); }
      /**
       * Join this room.
       ...
       */
      void send( const std::string& message, const std::string& html );
       ...
       * Use this function to remove the registered MUCRoomHandler.
       */
      MUCRoomHandler* getMUCRoomHandler() { return m_roomHandler; }
	  ...
	  // add by Quanli
	  // we should delete the mucroom 
	  void storeListNone( const MUCListItemList items);
