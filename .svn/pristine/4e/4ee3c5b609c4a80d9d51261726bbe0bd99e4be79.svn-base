  ...
  class GLOOX_API Message : public Stanza
  {
    ...
    public:
      ...
      Message( MessageType type, const JID& to,
               const std::string& body = EmptyString, const std::string& subject = EmptyString, const std::string& html = EmptyString,
	  ...
	  const std::string html( const std::string& lang = "default" ) const
	  {
		  return findLang( m_htmls, m_html, lang );
	  }
