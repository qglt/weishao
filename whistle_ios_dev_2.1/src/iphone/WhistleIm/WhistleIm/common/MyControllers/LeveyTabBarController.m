...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr andTitleArr:(NSArray *)titleArr;
{
	self = [super init];
	if (self != nil)
	{
		...
		_tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, _containerView.frame.size.height - kTabBarHeight, 320.0f, kTabBarHeight) buttonImages:arr andTitleArr:titleArr];
...
// me
- (void)showRedSpotIndicatorWithIndex:(NSUInteger)index andIsHidden:(BOOL)hidden
{
    [_tabBar showOrHiddenRedSpotWithIndex:index isHidden:hidden];
}
@end
